/*
You are given array a1,a2,…,an, consisting of non-negative integers.
...
Calculate x=ai1 & ai2 & … & aik, where & denotes the bitwise AND operation (notes section contains formal definition).
...
The first line of each test case contains one integer n (1≤n≤200000) — the length of array a.

The second line of each test case contains n integers a1,a2,…,an (0≤ai<230) — array a itself.

It's guaranteed that the sum of n over all test cases doesn't exceed 200000.
