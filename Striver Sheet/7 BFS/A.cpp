...
void sol()
{
    ...
    while (q.size())
    {
        ...
        if (curr.first.first >= n or curr.first.first < 0 or curr.first.second >= m or curr.first.second < 0)
            continue;
        ...
        if (!temp)
            break;
        temp--;
        q.push({{curr.first.first + 1, curr.first.second}, curr.second ^ arr[curr.first.first + 1][curr.first.second]});
        q.push({{curr.first.first, curr.first.second + 1}, curr.second ^ arr[curr.first.first][curr.first.second + 1]});
    }
    prn(ans);
}
