...
void sol()
{
    ...
    // we need to print 2k elements of each array with equal xor
    ...
    for (auto val : b)
        r[val]++;
    // vii ll(l.begin(), l.end());
    // vii rr(r.begin(), r.end());
    // sort(ll.begin(), ll.end(), [](auto f, auto s)
    //      { return f.second < s.second; });
    // sort(rr.begin(), rr.end(), [](auto f, auto s)
    //      { return f.second < s.second; });
    vi inBoth(n, 0);
    for (auto val : l)
    {
        if (val.second == 2)
        {
            inBoth[val.first - 1] = 2;
        }
        else
        {
            inBoth[val.first - 1] = 1;
        }
    }
    // prnv(all(inBoth));
    vector<int> ll;
    ...
    while (temp)
    {
        ...
        else
        {
            ...
            {
                ans1.push_back(ones[j]);
                ans2.push_back(ones[j]);
                j++;
            }
            temp--;
        }
