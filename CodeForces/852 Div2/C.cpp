...
void sol()
{
    ...
    while ((a.size() and b.size()) and (arr[i] == *a.begin() or arr[j] == *a.begin() or -arr[i] == *b.begin() or -arr[j] == *b.begin()))
    {
        if (arr[i] == *a.begin() or -arr[i] == *b.begin())
        {
            a.erase(arr[i]);
            b.erase(-arr[i]);
            i++;
        }
        else if (arr[j] == *a.begin() or -arr[j] == *b.begin())
        {
            a.erase(arr[j]);
            b.erase(-arr[j]);
            j--;
