...
A proper factor of a number is any factor of the number except the number itself. How easy is that? So, if our factors of 10 were 1, 2, 5, and 10, the proper factors of the number 10 are 1, 2, and 5! Remember that 10 is not a proper factor of itself.
The two integers are k
 and n−k
, where k
 is the largest proper factor of n
...
void sol()
{
    ...
    if (!proper_factor)
        proper_factor = n;
    prn2(ll(n / proper_factor), n - ll(n / proper_factor));
}
