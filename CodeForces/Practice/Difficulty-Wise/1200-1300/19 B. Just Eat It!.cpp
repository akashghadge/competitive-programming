...
/*
When we does not include all the subseq in the answer then there should we use trick of excluding ends of the arrary cause we know ends won't going to appear in answer at same time
*/
